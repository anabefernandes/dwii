...
$funcionario = new Funcionario($codigo, $nome, $valorHora, $horasTrabalhadas);
?>
<!doctype html>
<html lang="pt-br" data-bs-theme="auto">
  <head><script src="assets/color-modes.js"></script>
    ...
    <title>Cálculo Funcionário</title>
...
<div class="container">
  <main>
    <div class="py-5 text-center">
      ...
      <h2>Funcionário</h2>
      <p class="lead">Entre com os dados necessários para efetuar o calculo da folha de pagamento do funcionário.</p>
    </div>
        ...
        <ul class="list-group mb-3">
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              ...
              <small class="text-body-secondary"><?php echo $funcionario->getCodigo() ?></small>
            </div>
          </li>
          ...
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              ...
              <small class="text-body-secondary"><?php echo $funcionario->getNome(); ?></small>
            </div>
          </li>
          ...
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              ...
              <small class="text-body-secondary"><?php echo $funcionario->getValorHora(); ?></small>
            </div>
          </li>
          ...
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              ...
              <small class="text-body-secondary"><?php echo $funcionario->getHorasTrabalhadas(); ?></small>
            </div>
          </li>
          ...
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              ...
              <small class="text-body-secondary"><strong>R$<?php echo $funcionario->calcularSalario(); ?></strong></small>
            </div>
          </li>
        </ul>
        ...
        <form method="post">
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <div class="input-group">
                <input type="text" name="horasTrabalhadas" class="form-control" id="horasTrabalhadas" required>
              </div>
            </div>
