...
<body>
        ...
        <header>
            <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                ...
                <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                    ...
                    <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="#">Produtos</a>
                    <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="#">Contato</a>
                </nav>
            </div>
    ...
    foreach ($produtos as $produto) {
        ...
        echo '</ul>';
        echo '<button type="button" class="w-100 btn btn-lg btn-outline-primary">Comprar</button>';
        echo '</div></div></div>';
    }
